...
#Dependency is this script from https://github.com/dominictarr/JSON.sh

#Things to modify for your own instance. 

#Leave off the final / for this directory (where you git cloned the code)
...
tdir="/var/www/i2ppool/public_html/"

input=$(curl -X POST $api)
...
$pooltotminpaid<br> \n\
" > $dir/updatedinfo.html

cat $dir/updatedinfo.html >> $dir/index.html

sudo cp $dir/index.html $tdir
